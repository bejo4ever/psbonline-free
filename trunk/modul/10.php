...
<?php
session_start();
if(AKSESFILE!="ya"){ header("Location: index.php"); }
...
<h2>Edit Biodata Siswa Baru</h2>
<p><em>Silakan klik link 'edit' pada samping kanan nama Calon Siswa yang akan diubah biodatanya.</em></p>
...
$no = 0; $no = $no+1;
	while($row = mysql_fetch_array($result))
	  ...
	  <?php
		...
		echo "<td>";?>
		<a href="?p=11&i=<?php echo $row['id'];?>">Edit</a>
		<?php echo "</td>";
		echo '</tr>';
		$no++;
	  }
